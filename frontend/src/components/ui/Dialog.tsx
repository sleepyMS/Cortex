...
// 2025 Premium SaaS Dialog Component
  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={clsx(
        ...
        // Size
        "w-[calc(100vw-2rem)] max-w-full sm:max-w-md md:max-w-lg lg:max-w-4xl",
        // Styling - enhanced with better shadows and rounded corners
        "rounded-xl border bg-background p-0 shadow-xl",
        // Animation
        "duration-200",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",

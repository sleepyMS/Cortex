  ...
  return (
    <LegalPageLayout title="개인정보처리방침" lastUpdated="2025년 12월 8일">
      ...
      <section id="article-10">
        <h2>제10조 (웹 저장소의 사용)</h2>
        <ol>
          <li>
            회사는 이용자의 편의를 위해 브라우저의 '웹 저장소(localStorage)'를
            사용합니다. 웹 저장소는 이용자의 브라우저에 데이터를 저장하는
            기술입니다.
          </li>
          <li>
            회사는 다음과 같은 목적으로 웹 저장소를 사용합니다:
            <ul>
              <li>테마 설정 저장 (다크 모드/라이트 모드)</li>
              <li>로그인 상태 유지 (인증 토큰 저장)</li>
              <li>서비스 이용 편의를 위한 임시 데이터 저장</li>
            </ul>
          </li>
          <li>
            웹 저장소에 저장된 데이터는 이용자가 브라우저의 설정 또는 개발자
            도구를 통해 언제든지 삭제할 수 있습니다.
          </li>
          <li>
            웹 저장소 데이터를 삭제하면 로그인 상태가 해제되어 다시 로그인이
            필요할 수 있습니다.
          </li>
          <li>
            참고: 회사는 현재 쿠키(cookie)를 사용하지 않습니다. 향후 쿠키 사용이
            필요한 경우, 본 방침을 개정하여 사전에 고지하겠습니다.
          </li>
        </ol>
      </section>
